...
#ifndef ANDROID_C2_RK_GRALLOC_ORIGIN_H__
#define ANDROID_C2_RK_GRALLOC_ORIGIN_H__

class C2RKGrallocOrigin : public C2RKGrallocInterface {
public:
    static C2RKGrallocOrigin* getInstance() {
        static C2RKGrallocOrigin _gInstance;
        return &_gInstance;
    }
...
private:
    C2RKGrallocOrigin();
    virtual ~C2RKGrallocOrigin();

    const gralloc_module_t *mGralloc;
};

#endif /* ANDROID_C2_RK_GRALLOC_ORIGIN_H__ */
